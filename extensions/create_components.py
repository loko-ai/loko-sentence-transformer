...
is_multilabel = Arg(name="is_multilabel", label="Multilabel", type="boolean", value=False)
multi_target_strategy = Dynamic(name="multi_target_strategy", label="Multi-Target Strategy", dynamicType="select",
                                options=["one-vs-rest", "multi-output", "classifier-chain"], parent="is_multilabel", condition="{parent}===true")
