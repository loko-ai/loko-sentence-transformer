    ...
    return (
      ...
      <IconButton
        ...
        <Flex w="100vw" h="100vh" p="2rem" color="#000000">
          <div class="container">
          <div class="item" style={{backgroundColor: '#f2eed9', width: '1000px',height: '50px'}}><Text as='b' fontSize='30px' color='#81007F'>Sentence Transformer Model: <Text as='i' fontSize='30px' color='#C64B8C'>{name}</Text></Text></div>
